...
type Vehicle = { id: number; plate: string; active: boolean; fleetStatus?: FleetStatus; brand?: string; model?: string; year?: number; type?: string; branch?: string; currentKm?: number; fuelConsumptionTarget?: number; insuranceExpiry?: string; inspectionExpiry?: string };
...
function FleetModule({ vehicles, setVehicles, maintenance, setMaintenance, trips, fuelEntries, branches, onToast }: {
  ...
  function saveVehicleProfile(event: FormEvent<HTMLFormElement>) {
    ...
    const saved: Vehicle = { ...vehicleProfile, active: fleetStatus === "Activo", fleetStatus, brand: String(form.get("brand") || ""), model: String(form.get("model") || ""), year: Number(form.get("year") || 0) || undefined, type: String(form.get("type") || ""), branch: String(form.get("branch") || ""), currentKm: Number(form.get("currentKm") || 0), fuelConsumptionTarget: Number(form.get("fuelConsumptionTarget") || 0) || undefined };
