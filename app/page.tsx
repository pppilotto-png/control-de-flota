...
type Trip = { id: number; branch: string; startDate: string; endDate?: string; driver: string; helper?: string; vehicle: string; status: TripStatus; kmInitial: number; kmFinal: number; distanceSource?: DistanceSource; estimatedKm?: number; kmValidated?: boolean; validatedBy?: string; orders: Order[] } & ImportMetadata;
